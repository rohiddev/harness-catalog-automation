...
func updateSystem(e *Entity) {
	...
	setAnno(e, "chaos.harness.io/dashboard-url", env("SYSTEM_CHAOS_HARNESS_DASHBOARD_URL", ""))
	setAnno(e, "chaos.harness.io/gameday-runbook-url", env("SYSTEM_CHAOS_GAMEDAY_RUNBOOK_URL", ""))
	setAnno(e, "rafay.dev/project-name", env("SYSTEM_RAFAY_PROJECT_NAME", ""))
	setAnno(e, "rafay.dev/project-dashboard-url", env("SYSTEM_RAFAY_PROJECT_DASHBOARD_URL", ""))
